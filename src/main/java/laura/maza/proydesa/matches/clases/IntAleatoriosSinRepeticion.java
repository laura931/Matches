 ...
 */
package laura.maza.proydesa.matches.clases;
...
public class IntAleatoriosSinRepeticion {
    ...
    public static List<String> getListaIdProductosExistentes() {
        if( listaIdProductosExistentes == null)
    ...
    public static String crearIdProductosSinRepetir(String id){
        ...
        listaIdProductosExistentes = getListaIdProductosExistentes();
        if (listaIdProductosExistentes !=null && listaIdProductosExistentes.contains(id)){
